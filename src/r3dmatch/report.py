        ...
        clips.append(
            {
                ...
                "group_key": group_key,
                "original_frame": None,
                "exposure_corrected": None,
                "color_corrected": None,
                "metrics": {
                    "exposure": {
                        "raw_offset_stops": record.get("raw_offset_stops"),
                        "final_offset_stops": record.get("final_offset_stops"),
                        "measured_log2_luminance": exposure_entry.measured_log2_luminance if exposure_entry else None,
                    },
                    "color": {
                        "rgb_gains": (
                            [color_entry.rgb_neutral_gains["r"], color_entry.rgb_neutral_gains["g"], color_entry.rgb_neutral_gains["b"]]
                            if color_entry else None
                        ),
